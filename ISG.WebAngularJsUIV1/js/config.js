/// <reference path="../bower_components/ngcropper-master/dist/ngcropper.all.min.js" />
'use strict';
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
            ...
            resolve: {
                ...
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            name: 'ngCropper',
                            files: ['bower_components/ngCropper-master/dist/ngCropper.all.min.css',
                                'bower_components/ngCropper-master/dist/ngCropper.all.min.js',
                                'bower_components/ngCropper-master/dist/ngCropper.min.js']
                        }
                    ]);
                }
            },
        ...
        .state('SM.Og.Ozurluluk', {
            url: "/ozurluluk/:id",
            templateUrl: "/views/Personel/View/PersDetail/ozurluluk.html",
            data: { pageTitle: 'Engellilik Durumları' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('Egitim', {
            ...
            data: {
                permissions: {
                    only: ['Admin', 'ISG_Admin', 'ISG_Hekim', 'ISG_Uzman', 'ISG_SaglikMemuru'],
                    redirectTo: 'login'
                }
            },
            resolve: {
                ...
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            name: 'summernote',
                            files: ['bower_components/summernote/summernote.css', 'bower_components/summernote/summernote-bs3.css', 'bower_components/summernote/summernote.min.js', 'bower_components/summernote/angular-summernote.min.js']
                        }
                    ]);
                }
            },
        ...
        .state('Egitim.egt', {
            url: "/egt",
            templateUrl: "/views/Egitim/View/Egitim.html",
            data: { pageTitle: 'Eğitimler' },
            controller: "egitimCtrl",
            onExit: function (egitimSvc) {
                egitimSvc.Egitim.id = null;
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/egitimCtrl.js']
                        } ,
                        {
                            files: ['bower_components/clockpicker/dist/bootstrap-clockpicker.min.css',
                                'bower_components/clockpicker/dist/bootstrap-clockpicker.min.js']
                        },
                        {
                            serie: true,
                            name: 'angular-ladda',
                            files: ['bower_components/ladda-angular-master/dist/spin.min.js',
                                'bower_components/ladda-angular-master/dist/ladda.min.js',
                                'bower_components/ladda-angular-master/dist/ladda-themeless.min.css',
                                'bower_components/ladda-angular-master/dist/angular-ladda.min.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtKayit', {
            url: "/EgtKayit/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtKayit.html",
            data: { pageTitle: 'Eğitim Kaydı' },
            controller: "egtKayitCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtKayitCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtDersler', {
            url: "/EgtDersler/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtDersler.html",
            data: { pageTitle: 'Eğitim Ders Kayıtları' },
            controller: "egtDerslerCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtDerslerCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtAlanlar', {
            url: "/EgtAlanlar/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtAlanlar.html",
            data: { pageTitle: 'Eğitim Ders Kayıtları' },
            controller: "egtAlanlarCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtAlanlarCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtAlmayanlar', {
            url: "/EgtAlmayanlar/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtAlmayanlar.html",
            data: { pageTitle: 'Eğitim Almayanlar Ders Kayıtları' },
            controller: "egtAlmayanlarCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtAlmayanlarCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtSertifikasyon', {
            url: "/EgtSertifikasyon/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtSertifikasyon.html",
            data: { pageTitle: 'Sertifika Basımı' },
            controller: "egtSertifikasyonCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtSertifikasyonCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtNotlari', {
            url: "/EgtNotlari/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtNotlari.html",
            data: { pageTitle: 'Eğitim Notları' },
            controller: "egtNotlariCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtNotlariCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtPlanlama', {
            url: "/EgtPlanlama/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtPlanlama.html",
            data: { pageTitle: 'Eğitim Planlama' },
            controller: "egtPlanlamaCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtPlanlamaCtrl.js']
                        }
                    ]);
                }
            }
        })
        .state('Egitim.egt.EgtOnaylari', {
            url: "/EgtOnaylari/:id/:year",
            templateUrl: "/views/Egitim/View/child/EgtOnaylari.html",
            data: { pageTitle: 'Eğitim Onayları' },
            controller: "egtOnaylariCtrl",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            insertBefore: '#loadBefore',
                            files: ['views/Egitim/Controller/child/egtOnaylariCtrl.js']
                        }
                    ]);
                }
            }
...
var serviceBase = 'http://api.adresin.com/';
var storageLink = 'https://adresin.com/';
var IsAzureProject = false;//azurda çalışmak istiyorsan....
var eimzaLink = 'http://localhost:8085/';

///https ise api burada hata verebilir dikkatli olun.
