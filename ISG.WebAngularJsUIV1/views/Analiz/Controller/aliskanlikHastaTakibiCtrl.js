'use strict';
function aliskanlikHastaTakibiCtrl($scope, SMSvc, DTOptionsBuilder, DTColumnDefBuilder, analizSvc, personellerSvc) {
	var ahtC = this;
    ...
    var raporlar = function (Sirket_Id) {
        analizSvc.AliskanlikHastaTakibi(Sirket_Id).then(function (resp) {
            ahtC.raporlar = resp;
        });
    };
...
aliskanlikHastaTakibiCtrl.$inject = ['$scope', 'SMSvc', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'analizSvc', 'personellerSvc'];

angular
	.module('inspinia')
    .controller('aliskanlikHastaTakibiCtrl', aliskanlikHastaTakibiCtrl);